...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        KC_TAB,  KC_Q,    ALT_W,    CMD_E,    KC_R,    KC_T,    KC_Y,    KC_U,    CMD_I,    ALT_O,    KC_P,    KC_BSPC, KC_RBRC, KC_BSPC,
        CTL_ESC,  KC_A,    KC_S,    CNTRL_D,    SFT_F,    KC_G,    KC_H,    SFT_J,    CNTRL_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    EXPOSE,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, MT_RSFT_ENT,   MO(4),
        KC_LCTL, KC_CAPP, SPC_L,  MO(_karjalasta),   SPC_R,  KC_RALT, VL, MC, VR
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, CHROMETABSEARCH, _______, KC_END, KC_HOME, _______, _______, _______, _______,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, KC_CAPP, _______, _______, _______
    ),
